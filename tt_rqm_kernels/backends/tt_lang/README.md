...
The implementation uses row-major tensors and splits the four lanes into
`[block, 1]` slices inside TT-Lang. The compute kernel then forms each output
lane from the fixed Hamilton-product multiply/add/sign pattern.
